...
public class HotMenuActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.hotmenu);
	...
	private void setMenusAdapter() {
		...
		sa = new SimpleAdapter(this, data, R.layout.hotmenumain_item, from, to);
		// 为ListView绑定数据
		...
		// 设置确定按钮
				.setPositiveButton("确定", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int id) {
						...
						// 实例化SimpleAdapter
						sa = new SimpleAdapter(HotMenuActivity.this, data,
...
//		finish();
	...
	private void showDialogDelete(String str) {
		...
		new AlertDialog.Builder(HotMenuActivity.this)
...
class HotAdapter extends BaseAdapter {
	...
	@SuppressLint("UseSparseArrays")
	public HotAdapter(Context context, List<shopBean> list, Handler mHandler,
			int resourceId) {
		this.list = list;
	...
	public static void setIsSelected(HashMap<Integer, Boolean> isSelected) {
		HotAdapter.isSelected = isSelected;
	}
